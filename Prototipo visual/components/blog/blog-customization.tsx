...
import { Paintbrush, Upload, Type, Check } from "lucide-react"
...
const colors = [
  ...
  { id: "purple", value: "#8b5cf6", name: "Roxo" },
    ...
    <Card>
      ...
      <CardContent className="space-y-8">
        ...
        <div>
          ...
          <p className="mb-4 text-xs text-muted-foreground">
            Esta cor será usada em botões, links e destaques do seu blog.
          </p>
          <div className="flex flex-wrap gap-3">
            ...
            <button className="flex h-12 w-12 items-center justify-center rounded-xl border-2 border-dashed border-border text-muted-foreground hover:border-primary hover:text-primary">
              +
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mb-4 text-xs text-muted-foreground">
            Escolha a fonte que será usada nos textos do blog.
          </p>
