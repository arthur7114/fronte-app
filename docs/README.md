...
- `03-information-architecture.md` — **navegação, telas e fluxos (v2.0 — após redesign)**
...
- `06-data-model-and-entities.md` — **entidades do sistema (v2.0 — inclui Estratégia como entidade primária)**
...
- `14-ux-and-ia-redesign.md` — **fonte de verdade de UX/IA (v1.1) — carregar sempre que tocar telas, rotas ou estados**
...
4. Para implementação:
   ...
   - **telas, fluxos e navegação: `03-information-architecture.md` + `14-ux-and-ia-redesign.md`** (carregar ambos)
   - regras: `04-functional-requirements.md`
   - restrições técnicas: `05-non-functional-requirements.md`
   - **entidades e banco: `06-data-model-and-entities.md`**
   ...
   - **decisões de UX/IA (estados, terminologia, fluxos): `14-ux-and-ia-redesign.md`**
