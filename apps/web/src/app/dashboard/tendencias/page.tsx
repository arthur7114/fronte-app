  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Enquanto fontes externas ainda nao entram no produto, esta pagina assume os topic candidates como radar honesto do que o motor encontrou e do que merece sua atencao."
      />
