  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Ainda nao temos analytics externos conectados, mas ja conseguimos ler a maturidade do funil de conteudo pelo que o sistema produz e conclui."
      />
        ...
        <article className="dashboard-surface rounded-lg p-6">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2">
            ...
            <div className="rounded-lg border border-border bg-secondary/35 p-4">
              ...
              <p className="mt-2 text-sm leading-7 text-muted-foreground">
                Search Console, GA4 e metricas de keyword ainda entram numa fase seguinte.
              </p>
            </div>
          </div>
        </article>
