...
import { publicAddLeadAction } from "@/actions/leads-actions"
import type { LeadOrigin } from "@/lib/leads-server"
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      try {
        ...
        setError("Ocorreu um erro ao assinar a newsletter.")
      }
    })
  }
