      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-background/95 px-4 lg:px-6 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="flex items-center gap-3 lg:gap-0">
            ...
            {/* Project Selector - Usually Desktop only or adapted for mobile */}
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="gap-2 px-2 lg:px-3">
                  ...
                  <div className="hidden lg:flex flex-col items-start">
                    ...
                    <span className="text-xs text-muted-foreground">{site ? `${site}.antigravity.blog` : "Sem site configurado"}</span>
                  </div>
          ...
          <div className="flex items-center gap-1 lg:gap-2">
            {/* Search */}
            <Button variant="ghost" size="icon" className="hidden lg:inline-flex text-muted-foreground">
        ...
        {/* Mobile Navigation */}
        {mobileOpen && (
          <div className="lg:hidden border-b border-border bg-sidebar px-4 py-3">
