  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="relative isolate overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(18,179,166,0.12),transparent_28%),radial-gradient(circle_at_80%_20%,rgba(249,115,22,0.1),transparent_22%),linear-gradient(180deg,rgba(255,255,255,0.45),transparent_35%)]" />
