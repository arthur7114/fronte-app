    ...
    <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
      <div className="border border-black/12 bg-[rgba(255,255,255,0.84)] p-6 shadow-[0_24px_80px_rgba(17,17,17,0.08)] sm:p-8">
        <div className="flex items-end justify-between gap-4">
          ...
          <Link
            href="/app/posts/new"
            className="inline-flex h-11 items-center justify-center border border-black bg-black px-4 text-xs font-semibold uppercase tracking-[0.24em] text-white transition duration-200 hover:-translate-y-0.5"
          >
            Novo post
          </Link>
        </div>
        ...
        <div className="mt-6 overflow-hidden border border-black/10">
          <div className="grid grid-cols-[1.4fr_0.8fr_0.8fr_0.8fr_0.8fr] border-b border-black/10 bg-[#fbf7f1] px-4 py-3 text-[11px] font-semibold uppercase tracking-[0.24em] text-black/45">
            <span>Titulo</span>
            <span>Status</span>
            <span>Slug</span>
          ...
          {posts.length === 0 ? (
            ...
            posts.map((post) => (
              <Link
                ...
                className="grid grid-cols-[1.4fr_0.8fr_0.8fr_0.8fr_0.8fr] border-b border-black/8 px-4 py-4 text-sm transition duration-200 hover:bg-white/70 last:border-b-0"
              >
