...
export default function CalendarioPage() {
  ...
  const filteredEvents = useMemo(() => {
    if (strategyFilter === "all") return CALENDAR_EVENTS
    return CALENDAR_EVENTS.filter((e) => e.strategyId === strategyFilter)
  }, [strategyFilter])
  ...
  return (
    <Card>
      <CardContent className="flex items-center gap-4 p-5">
        <div className={`flex h-10 w-10 items-center justify-center rounded-xl bg-muted ${tint}`}>
