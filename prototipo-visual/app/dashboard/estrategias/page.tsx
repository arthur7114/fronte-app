...
export default function EstrategiasListPage() {
  const [strategies, setStrategies] = useState<Strategy[]>(() => listStrategies())
  ...
  const aggregate = strategies.reduce(
    (acc, s) => {
      const stats = getStrategyStats(s.id)
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <Button asChild className="gap-2">
          <Link href="/dashboard/estrategias/nova">
      ...
      {strategies.length === 0 ? (
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {strategies.map((strategy) => {
            ...
            const href = `/dashboard/estrategias/${strategy.id}`
            return (
              <Card
                key={strategy.id}
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
                          onSelect={() => handleDelete(strategy.id)}
